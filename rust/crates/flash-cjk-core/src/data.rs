...
//! scripts/export_rs.lua from the JSON dictionaries and embedded at
//! compile time -- they stay the single source of truth; the Korean
//! prefix map is derived from the generated jamo tables at first use.
